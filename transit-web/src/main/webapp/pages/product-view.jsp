				...
				<div class="row rowfluidalignment">
					<div class="col-sm-12">
						...
						<form:form modelAttribute="productViewRequest"
							action="view-product" method="post">
								...
								<div class="row Overview-section">
									<div class="widgetDescriptionRow">
										<fieldset class="col-sm-3 form-group">
											...
											<form:input id="productId" name="productId" path="productId"
										...
										<fieldset class="col-sm-3 form-group">
											...
											<form:select id="ptoId" name="ptoId" path="ptoId"
												disabled="true" onblur="validatePto();" class="form-control">
												<form:option value="">..:Select:..</form:option>
										...
										<fieldset class="col-sm-3 form-group">
											...
											<form:input id="productType" path="productType"
												name="productType" class="form-control" readonly="true"
										...
										<fieldset class="col-sm-3 form-group">
											<legend class = "custom-legend-view"><span class="requiredFiled">*</span>Ticket/Pass
												Type</legend>
											<form:input id="ticketAndPassType" name="ticketAndPassType"
										...
										<fieldset class="col-sm-3 form-group">
											...
											<form:input id="validFrom" name="validFrom" path="validFrom"
												class="form-control" readonly="true" type="text" value=""
												maxlength="50" autocomplete="off"></form:input>
											<div class="discriptionErrorMsg">
												<span id="descriptionMsgDiv" class="red-color-error">&nbsp;</span>
										...
										<fieldset class="col-sm-3 form-group">
											...
											<form:input id="validTo" name="validTo" path="validTo"
												class="form-control" readonly="true" type="text" value=""
												maxlength="50" autocomplete="off"></form:input>
											<div class="discriptionErrorMsg">
												<span id="descriptionMsgDiv" class="red-color-error">&nbsp;</span>
