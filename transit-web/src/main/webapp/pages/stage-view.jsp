			...
			<div class="searchConteiner">
				<div class="row rowfluidalignment">
					<div class="col-sm-12">
						...
						<form:form modelAttribute="stagesearchrequest" action="stage-view"
							method="post">
										...
										<div class="col-xs-12 col-sm-12 content-wrapper">
													<div class="col-xs-12 label-align">
														<label><span fontsize="2px"
															style="color: #8866ff;"> Add Stops </span></label>
													</div>
													...
													<form id="dataFieldsMgmtRequest" method="post">
														<fieldset class="col-sm-12 totalFields" id="readRecord">
															...
															<tr id="addRowId0">
															<c:forEach items="${stopView}"
													          var="stopView">
											
																<td>
																	<fieldset class=" col-sm-4 data_filed">
																		<legend class = "custom-legend"><span class="requiredFiled">*</span><span
																			class="imp-star">Stop Sequence Number</span></legend>
																		<form:input class="form-control"
																			id="stopSequenceNumber" readonly="true"
																			name="dataFieldList[0].stopSequenceNumber" value="${stopView.stopSequenceNumber}"
																			path="stopSequenceNumber"></form:input>
																		<div class="discriptionErrorMsg">
																...
																<td>
																	<fieldset class="col-sm-4 data_filed">
																		...
																		<form:input class="form-control" id="stopName"
																			readonly="true" value="${stopView.stopName}"
																			path="stopName"></form:input>
																		<div class="discriptionErrorMsg">
																			<span id="dataFieldNameError0"
																				class="error-span-hide red-error"></span>
																		</div>
																...
																<td>
																	<fieldset class="col-sm-4 data_filed">
																		...
																		<form:input class="form-control" id="distance"
																			readonly="true" name="dataFieldList[0].distance" value="${stopView.distance}"
