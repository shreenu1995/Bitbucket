...
<title>Device Manufacturer Create</title>
			...
			<div class="col-xs-12 content-wrapper">
				...
				<div class="searchConteiner">
					<div class="row rowfluidalignment">
						<div class="col-sm-12">
							<!-- Page Form Start -->
							<form:form modelAttribute="deviceManufacturerRequest"
								action="device-manufacturer-registration" method="post">
								<div class="col-sm-12 widgetDescriptionForm">
									<div class="row">
										<div class="widgetDescriptionRow">
											<fieldset class="col-sm-3 form-group">
												...
												<form:select id="deviceTypeId" path="deviceTypeId" name ="deviceTypeId"
													onblur="validateDeviceType();" Class="form-control">
										...
										<div class="widgetDescriptionRow">
											<fieldset class="col-sm-3 form-group">
												<legend class = "custom-legend-view"><span class="requiredFiled">*</span>Device
													Manufacturer Name</legend> <input id="deviceManufacturer"
													name="deviceManufacturer" class="form-control"
													onblur="validateDeviceManufacturer();" type="text" value=""
										...
										<fieldset class="form-group">
											<div
												...
												<input type="submit" value="Create"
													...
													onclick="return validateDeviceManufacturerSubmit();" /> <a
													href="device-manufacturer-registration"
