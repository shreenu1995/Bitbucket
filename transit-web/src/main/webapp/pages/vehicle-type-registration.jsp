				...
				<div class="searchConteiner">
					<div class="row rowfluidalignment">
						<div class="col-sm-12">
							...
							<!-- Page Form Start -->
							<form:form modelAttribute="vehicleTypeRequest"
								action="vehicle-type-registration" method="post">
								<div class="col-sm-12 widgetDescriptionForm">
									<div class="row">
										<div class="widgetDescriptionRow">
											<fieldset class="col-sm-3 form-group">
												<legend class = "custom-legend-view"><span class="requiredFiled">*</span>Vehicle
													Type Name</legend> <input id="vehicleTypeId" name="vehicleType"
									...
									<!-- Form Button Start -->
									<div class="col-sm-12 role-makerchecker-btn">
										<fieldset class="form-group">
											<div
												class="col-sm-6 widgetSearchButton no-search-criteria padding0 "
												style="float: right">
												<input type="submit" id="user-search" value="Create"
													onclick="return validateVehicleTypeSubmit();"
													class="form-control button pull-right" onclick="">
												<a href="vehicle-type-registration"
