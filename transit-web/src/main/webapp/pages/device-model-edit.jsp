			...
			<div class="searchConteiner">
				<div class="row rowfluidalignment">
					<div class="col-sm-12">
						...
						<form:form modelAttribute="deviceModelEditRequest"
							action="device-model-edit" method="post">
							<div class="col-sm-12 widgetDescriptionForm">
								...
								<div class="row Overview-section">
									<div class="widgetDescriptionRow">
										<fieldset class="col-sm-3 form-group">
											<legend class = "custom-legend"><span class="requiredFiled"></span><span
												class="imp-star"> Devie Model Id</span></legend>
											<form:input id="deviceId" name="deviceId" path="deviceId"
												onblur="" readonly="true" class="form-control" type="text"
												value="" maxlength="13"></form:input>
											<div class="discriptionErrorMsg">
												<span id="deviceModelIDMsgDiv" class="red-color-error">&nbsp;</span>
											</div>
										</fieldset>
									</div>
									<div class="widgetDescriptionRow">
										...
										<fieldset class="col-sm-3 form-group">
											...
											<form:select id="deviceTypeId" name="deviceTypeId"
												path="deviceTypeId" class="form-control" maxlength="50"
									...
									<div class="widgetDescriptionRow">
										...
										<fieldset class="col-sm-3 form-group">
											...
											<form:select id="deviceManufacturerCode"
												name="deviceManufacturerCode" path="deviceManufacturerCode" maxlength="50"
												class="form-control" onblur="validateDeviceManufacturer();">
												<form:option value="">..:Select:..</form:option>
									...
									<div class="widgetDescriptionRow">
										...
										<fieldset class="col-sm-3 form-group">
											<legend class = "custom-legend"><span class="requiredFiled">*</span><span
												class="imp-star">Device Model</span></legend>
											<form:input id="deviceModel" name="deviceModel"
												path="deviceModel" class="form-control"
												onblur="validateDeviceModel();" type="text" value=""
									...
									<div class="widgetDescriptionRow clearBoth">
										<fieldset class="col-sm-3 form-group">
											...
											<form:input cssClass="form-control" path="deviceIMEINumber"
												id="deviceIMEINumber" name="deviceIMEINumber" maxlength="13"
										...
										<fieldset class="col-sm-3 form-group">
											<legend class = "custom-legend"><span class="requiredFiled">*</span><span
												class="imp-star">Description</span></legend>
											<form:input id="description" name="description"
												path="description" class="form-control"
												onblur="validateDescription();" type="text" value=""
									...
									<fieldset class="form-group">
										<div
											...
											<input type="submit" id="deviceModelUpdate" value="Update"
												onclick="return validateDeviceModelEditSubmit();"
