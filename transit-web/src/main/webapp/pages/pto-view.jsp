					...
					<div class="searchConteiner">
						<div class="row rowfluidalignment">
							<div class="col-sm-12">
								...
								<!-- Page Form Start -->
								<form:form modelAttribute="ptoView"
									action="pto-update" method="post">
									<div class="col-sm-12 widgetDescriptionForm">
										<div class="row">
											<div class="widgetDescriptionRow">
												<fieldset class="col-sm-3 form-group">
													<legend class = "custom-legend"><span class="requiredFiled">*</span>PTO Id</legend>
													<form:input id="ptoMasterId" name="ptoMasterId"
														path="ptoMasterId" readOnly="true" class="form-control"
											...
											<div class="widgetDescriptionRow">
												<fieldset class="col-sm-3 form-group">
													...
													<form:select id="orgId" name="orgId"
														path="orgId" onblur="validateOrganization();" disabled="true"
											...
											<div class="widgetDescriptionRow">
												...
												<fieldset class="col-sm-3 form-group">
													...
													<form:input id="state" name="state" path="state" readOnly="true"
														class="form-control" type="text" onblur="validateState();"
														value="" maxlength="20" autocomplete="off" />
													<div class="discriptionErrorMsg">
											...
											<div class="widgetDescriptionRow">
												<fieldset class="col-sm-3 form-group">
													...
													<form:input id="contactPerson" name="contactPerson"
														path="contactPerson" class="form-control" readOnly="true"
											...
											<div class="widgetDescriptionRow">
												<fieldset class="col-sm-3 form-group">
													...
													<form:input id="ptoMobile" name="ptoMobile" readOnly="true"
											...
											<div class="widgetDescriptionRow">
												<fieldset class="col-sm-3 form-group">
													...
													<form:input id="ptoEmail" name="ptoEmail" path="ptoEmail" readOnly="true"
														class="form-control" onblur="validateEmail();" type="text"
														value="" maxlength="32" autocomplete="off" />
													<div class="discriptionErrorMsg">
											...
											<div class="widgetDescriptionRow">
												<fieldset class="col-sm-3 form-group">
													...
													<form:input id="siteUrl" name="siteUrl" path="siteUrl" readOnly="true"
														class="form-control"
														onblur="this.value=this.value.trim();return validateSiteURL();"
														type="text" value="" maxlength="32" autocomplete="off" />
													<div class="discriptionErrorMsg">
