...
<title>Payment Gateway Create</title>
				...
				<div class="row rowfluidalignment">
					<div class="col-sm-12">
						...
						<form:form modelAttribute="pgRequest"
							action="pg-onboarding-create" method="post">
								...
								<div class="row Overview-section">
									...
									<div class="widgetDescriptionRow">
										<fieldset class="col-sm-3 form-group">
											<legend class = "custom-legend"><span class="requiredFiled">*</span>Currency</legend>
											<form:select id="currency" path="currency"
												class="form-control"
												onchange="fetchPM(this.value, 'currency')"
												onblur="validateCurrency();">
												<form:option value="">..:Select:..</form:option>
												<form:option value="INR">INR</form:option>
												<form:option value="USD">USD</form:option>
												<form:option value="ZAR">ZAR</form:option>
											</form:select>
											<div class="discriptionErrorMsg">
												<span id="currencyMsgDiv" class="red-color-error">&nbsp;</span>
											</div>
										</fieldset>
									</div>
									...
									<div class="widgetDescriptionRow">
										...
										<fieldset class="col-sm-3 form-group">
											<legend class = "custom-legend"><span class="requiredFiled">*</span><span
												class="imp-star">Acquirer PM</span></legend>
											<form:select id="pgName" path="pgName" class="form-control"
												type="text" maxlength="50" onblur="validatePgName();">
												<form:option value="">..:Select:..</form:option>
											</form:select>
											<div class="discriptionErrorMsg">
									...
									<div class="widgetDescriptionRow">
										<fieldset class="col-sm-3 form-group">
											<legend class = "custom-legend"><span class="requiredFiled">*</span><span
												class="imp-star">MID</span></legend>
											<form:input id="mid" path="mid"
												class="form-control" type="text" maxlength="50"
												onblur="validateMID();"></form:input>
											<div class="discriptionErrorMsg">
												<span id="midMsgDiv" class="red-color-error">&nbsp;</span>
											</div>
										</fieldset>
									</div>
								...
								<div class="role-makerchecker-btn">
									<fieldset class="form-group">
										<div
											...
											<input type="submit" id="pg-onboarding-create" value="Create"
												class="form-control button pull-right"
												onclick="return ValidatePg();"> <a
