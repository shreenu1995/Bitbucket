...
<title>Transit Master Edit</title>
					...
					<div class="searchConteiner">
						<div class="row rowfluidalignment">
							<div class="col-sm-12">
								...
								<form action="transit-master-search" name="cancelForm"
									method="post" value="">
									<input type="hidden" id="cancelTypeId" name="cancelTypeId" />
								</form>

								<!-- Page Form Start -->
								<form:form modelAttribute="transitMasterEditRequest"
									action="transit-master-edit" method="post">
									<div class="col-sm-12 widgetDescriptionForm">
										<div class="row">

											<div class="widgetDescriptionRow">
												<fieldset class="col-sm-3 form-group">
													<legend class = "custom-legend"><span class="requiredFiled">*</span>Transit
														Master Id</legend>
                                           ...
                                           <c:choose>
											...
											<div class="widgetDescriptionRow">
												<fieldset class="col-sm-3 form-group">
													...
													<form:select id="organizationId" name="organizationId"
														...
														onblur="validateOrgList();" Class="form-control">
													...
													<div class="discriptionErrorMsg">
														<span id="orgListMsgDiv" class="red-color-error">&nbsp;</span>
													</div>
												</fieldset>
											</div>
											...
											<div class="widgetDescriptionRow">
												<fieldset class="col-sm-3 form-group">
													...
													<form:select id="ptoId" class="form-control"
														onblur="validatePto();" path="ptoId" name="ptoId">
														<form:option value="">..:Select:..</form:option>
													...
													<c:otherwise>
														<fieldset class="col-sm-3 form-group">
															...
															<div class="discriptionErrorMsg">
																<span id="organizationMsgDiv" class="red-color-error">&nbsp;</span>
															</div>
														</fieldset>
														<fieldset class="col-sm-3 form-group">
											...
											<div class="widgetDescriptionRow">
												<fieldset class="col-sm-3 form-group">
													...
													<form:input cssClass="form-control" name="versionNumber"
														path="versionNumber" id="versionNumber" maxlength="50"
														onblur="this.value=this.value.trim();validateVersionNumber();"
														onclick="clearErrorMsg('versionNumberMsgDiv');"
											...
											<div class="widgetDescriptionRow">
												<fieldset class="col-sm-3 form-group">
													...
													<form:select id="inherit" name="inherit"
														class="form-control" path="inherit"
														onblur="validateInherit();">
														<form:option value="">..:Select:..</form:option>
														<c:forEach items="${transitMasterInheritPtoList}"
															var="transitMasterInheritPtoList">
															<form:option
																value="${transitMasterInheritPtoList.inherit}">${transitMasterInheritPtoList.inherit}</form:option>
														</c:forEach>
													</form:select>
													<div class="discriptionErrorMsg">
											...
											<div class="widgetDescriptionRow">
												<fieldset class="col-sm-3 form-group">
													...
													<div class="input-group generationDate">
														<form:input name="deliveryDate" path="deliveryDate"
															id="deliveryDate" class="form-control generationDateshow"
															autocomplete='off'></form:input>
													...
													<div class="discriptionErrorMsg">
														<span id="deliveryDateMsgDiv" class="red-color-error"></span>
													</div>
												</fieldset>
											</div>
											...
											<div class="widgetDescriptionRow">
												<fieldset class="col-sm-3 form-group">
													<legend class = "custom-legend"> Apply
														Date </legend>
													<div class="input-group generationDate">
														<form:input class="form-control generationDateshow"
															name="applyDate" path="applyDate" id="applyDate"
															autocomplete='off'></form:input>
														<label class="input-group-addon btn"
															for="generationDateStart"> <span
															class="fa fa-calendar" onclick="showDate('deliveryDate')"></span>
													...
													<div class="discriptionErrorMsg">
														<span id="applyDateMsgDiv" class="red-color-error"></span>
													</div>
												</fieldset>
											</div>
											...
											<div class="widgetDescriptionRow">
												<fieldset class="col-sm-3 form-group">
													...
													<form:input cssClass="form-control" name="description"
														path="description" id="Description" maxlength="250"
											...
											<div class="widgetDescriptionRow">
												<fieldset class="col-sm-3 form-group">
													<legend class = "custom-legend"><span class="requiredFiled">*</span><span
														class="imp-star">Full Version</span></legend>
													<form:select id="fullVersion" class="form-control"
														path="fullVersion" onblur="validateFullVersion();"
														name="fullVersion">
														<form:option value="">..:Select:..</form:option>
										...
										<div class="role-makerchecker-btn">
											<fieldset class="form-group">
												<div
													...
													<input type="submit" id="transitMasterUpdate"
														value="Update"
														onclick="return validateTransitMasterEditSubmit();"
