...
<title>View Vehicle Onboard</title>
	...
	<div class="container-fluid cw-admin-search-widget">
		...
		<div class="col-xs-12 content-wrapper">
			...
			<div class="breadCrumb">
						...
						<span class="glyphicon glyphicon-play icon-font-size"></span> 
						<span class="breadcrumb-text">Vehicle Onboard</span> 
			...
			<div class="searchConteiner">
				<div class="row rowfluidalignment">
					<div class="col-sm-12">
						...
						<form:form modelAttribute="vehicleOnboardViewRequest"
							action="vehicle-onboard-view" method="post">
									...
									<div class="widgetDescriptionRow">
										...
										<fieldset class="col-sm-3 form-group">
											<legend class = "custom-legend"><span class="requiredFiled">*</span>PTO
												Name</legend>
											<form:input id="ptoName" path="ptoName" name="ptoName"
