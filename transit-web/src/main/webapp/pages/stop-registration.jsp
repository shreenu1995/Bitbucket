	...
	<div id="wrapper">
		...
		<div class="container-fluid cw-admin-search-widget">
			...
			<div class="col-xs-12 content-wrapper">
				...
				<span class="success-msg help-block align-center" id="sucess">${success}</span>
				...
				<div class="searchConteiner">
					<div class="row rowfluidalignment">
						<div class="col-sm-12">
							...
							<!-- Page Form Start -->
							<form:form modelAttribute="stopRegistrationRequest"
								action="stop-registration" method="post">
									...
									<div class="row">
										<div class="widgetDescriptionRow">
											...
											<fieldset class="col-sm-3 form-group">
												...
												<select id="stageId" name="stageId" path="stageId"
													onclick="" onblur="validateStageName();" 
													class="form-control" onblur="">
													<option value="">..:Select:..</option>
													<c:forEach items="${stageNameList}" var="stageNameList">
														<option value="${stageNameList.stageId}">${stageNameList.stageName}</option>
													</c:forEach>
											...
											<fieldset class="col-sm-3 form-group">
												...
												<form:input cssClass="form-control" path="stopName"
													id="stopName" maxlength="50"
													onblur="this.value=this.value.trim();validateStopName();"
													onclick="clearErrorMsg('stopNameMsgDiv');"
										...
										<fieldset class="form-group">
											<div
												...
												<input type="submit" value="Create"
													...
													onclick="return validateStopSubmit()" /> <a
													href="stop-registration"
