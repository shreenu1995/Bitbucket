			...
			<div class="searchConteiner">
				<div class="row rowfluidalignment">
					<div class="col-sm-12">
						...
						<form:form modelAttribute="deviceTypeViewRequest"
							action="view-device-type" method="post">
								...
								<div class="row Overview-section">
									<div class="widgetDescriptionRow">
										<fieldset class="col-sm-3 form-group">
											...
											<form:input id="deviceTypeId" name="deviceTypeId"
										...
										<fieldset class="col-sm-3 form-group">
											...
											<form:input id="deviceTypeName" path="deviceTypeName"
												name="deviceTypeName" class="form-control" readonly="true"
												type="text" autocomplete="off"></form:input>
