...
<title>Transit Master Create</title>
...
<script src="../js/transitMasterMaintenance.js" type="text/javascript"></script>
						...
						<div class="row rowfluidalignment">
							<div class="col-sm-12">
								...
								<form:form modelAttribute="transitMasterRegistrationRequest"
									action="transit-master-registration" method="post">
									<div class="col-sm-12 widgetDescriptionForm">
											...
											<div class="widgetDescriptionRow">
												<fieldset class="col-sm-3 form-group">
													<legend class = "custom-legend"><span class="requiredFiled">*</span><span
														class="imp-star">PTO Name</span></legend>  <form:select id="ptoId"
														name="ptoId" path="ptoId" onblur="validatePto();"
										...
										<c:otherwise>
												<fieldset class="col-sm-3 form-group">
													...
													<form:select id="organizationId" name="organizationId"
														path="organizationId" Class="form-control" onblur="validateOrgList();">
														<c:forEach items="${organizationList}"
															var="organizationList">
															<form:option value="${organizationList.orgId}">${organizationList.organizationName}</form:option>
														</c:forEach>
													...
													<div class="discriptionErrorMsg">
														<span id="orgListMsgDiv" style="color: red;">&nbsp;</span>
													</div>
												</fieldset>
											...
											<div class="widgetDescriptionRow">
												...
												<fieldset class="col-sm-3 form-group">
													<legend class = "custom-legend"><span class="requiredFiled">*</span> Version
														Number </legend>
													<form:input cssClass="form-control" path="versionNumber"
														id="versionNumber" maxlength="50"
														onblur="validateVersionNumber();"
										...
										<div class="role-makerchecker-btn">
											<fieldset class="form-group">
												<div class="col-sm-6 widgetSearchButton no-search-criteria padding0">
													<input type="submit" value="Create" class="form-control button pull-right"
														onclick="return validateTransitMasterSubmit();" />
													<a href="transit-master-registration" class="form-control button pull-right"><legend class = "custom-legend-button">Reset</legend>
													</a> 
												</div>
											</fieldset>
										</div>
